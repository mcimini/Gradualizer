...
typeOfGr (absInf E) (arrow T1 T2) :- (pi x\ (typeOfGr x T1 => typeOfGr (E x) T2)), static T1, static T1.
typeOfCC (app E1 E2) T2 :- typeOfCC E1 (arrow T1 T2), typeOfCC E2 T1.
typeOfCC (absInf E) (arrow T1 T2) :- (pi x\ (typeOfCC x T1 => typeOfCC (E x) T2)).
...
typeOfCI (absInf E) (absInf (x\ (E' x))) (arrow T1 T2) :- (pi x\ (typeOfCI x x T1 => typeOfCI (E x) (E' x) T2)), static T1, static T1.
...
join2 X X X.
static (int).
static (arrow X1 X2) :- static X1, static X2.
